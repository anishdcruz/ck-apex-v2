<template>
    <div>
        <panel ref="panel" :heading="heading" :resource="resource">
            <span slot="title">Sales Orders</span>
            <router-link slot="create" to="/sales_orders/create" class="btn btn-primary">
                New Sales Order
            </router-link>
