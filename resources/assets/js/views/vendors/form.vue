                ...
                <div class="row">
                    ...
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" v-model="form.payment_details">
                            </textarea>
                            <error-text :error="error.payment_details"></error-text>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function initializeUrl (to) {
        let urls = {
            ...
            'clone': `/api/vendors/${to.params.id}/edit?mode=clone`,
        }
    ...
    export default {
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.$title.set(`Vendor ${this.title}`)
                this.$bar.finish()
                this.show = true
            }
        }
